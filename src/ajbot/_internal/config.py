...
ENV_VAR_DISCORD = '_'.join(i.upper() for i in [KEY_SERVER, KEY_USER_DISCORD])
ENV_VAR_DRIVE = '_'.join(i.upper() for i in [KEY_SERVER, KEY_USER_DRIVE])
...
DISCORD_ID_ME = 490802833273257994
